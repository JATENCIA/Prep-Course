...
function esPositivo(numero) {
  ...
  if (numero === 0 || typeof numero !== "number") return false;
  else {
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
  if (typeof nombre !== "string" || typeof apellido !== "string") return false;
...
function obtenerAreaRectangulo(alto, ancho) {
  ...
  // Tu código:
  if (typeof alto !== "number" || typeof ancho !== "number") return false;
  else return alto * ancho;
}

function retornarPerimetro(lado) {
  //Escibe una función a la cual reciba el valor del lado de un cuadrado y retorne su perímetro.
  //Escribe tu código aquí
  if (typeof lado !== "number") return false;
  else return 4 * lado;
}
...
function areaDelTriangulo(base, altura) {
  ...
  //Escribe tu código aquí
  if (typeof base !== "number" || typeof altura !== "number") return false;
...
function deEuroAdolar(euro) {
  ...
  //Escribe tu código aquí
  if (typeof euro !== "number") return false;
  else return 1.2 * euro;
}
