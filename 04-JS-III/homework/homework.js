...
function incrementarPorUno(array) {
  ...
  array.forEach(function (elemet) {
    array2.push(elemet + 1);
  });
  return array2;
}
...
function diaDeLaSemana(numeroDeDia) {
  ...
  else if (numeroDeDia === 4) return "Es dia Laboral";
  else if (numeroDeDia === 5) return "Es dia Laboral";
  else if (numeroDeDia === 6) return "Es dia Laboral";
...
function mesesDelAño(array) {
  ...
  // Tu código:
  const arrayMeses = ["Enero", "Marzo", "Noviembre"];
  const arrayResult = [];
  array.forEach((element) => {
    if (arrayMeses.includes(element)) arrayResult.push(element);
  });
...
function mayorACien(array) {
  ...
  array.forEach((element) => {
    if (element > 100) arrayResult.push(element);
  });
  return arrayResult;
}
